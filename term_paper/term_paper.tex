...
The variable \emph{gender} distinguishes gender. There are 17,130 males
in this dataset and 17,870 females.
...
above given that if an individual does not have a financial account, we
would expect they are less likely to have a source of emergency funds,
as emergency funds are generally stored in an account.
...
\includegraphics{term_paper_files/figure-latex/unnamed-chunk-8-1.pdf}
...
only 8,348 individuals receive wage payments from the \emph{Receive Wage
Payments} variable while 26,241 do not. This analysis suggests that
receiving wage payments may be a key factor in determining access to
emergency funds.
...
\includegraphics{term_paper_files/figure-latex/unnamed-chunk-10-3.pdf}

\includegraphics{term_paper_files/figure-latex/unnamed-chunk-11-5.pdf}
...
\includegraphics{term_paper_files/figure-latex/unnamed-chunk-13-7.pdf}
