...
The first variable being *account_fin* which distinguishes those who have a financial account from those who don’t. We found 11,970 respondents have a financial account while 23,030 respondents do not. This means about two thirds of individuals do not have an account. This is likely connected to the lack of access to emergency funds displayed above given that if an individual does not have a financial account, we would expect they are less likely to have a source of emergency funds, as emergency funds are generally stored in an account.
...
Diving further into the "Money from Working" category, we can see that only 8,348 individuals receive wage payments from the *Receive Wage Payments* variable while 26,241 do not. This analysis suggests that receiving wage payments may be a key factor in determining access to emergency funds.
