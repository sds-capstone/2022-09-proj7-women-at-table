...
```{python}
# Read in Data
file = '~/Documents/Smith College/SDS Capstone/2022-09-proj7-women-at-table/findex_SubSahAfrica.csv'
...
df2.rename(columns = {'fin32': 'Receive Wage Payments', 'fin48': 'National ID', 'educ': 'Education', 'fin25': 'main_source_funds', 'fin32': 'Recieve Wage Payments'}, inplace = True)
df2.head()
```
