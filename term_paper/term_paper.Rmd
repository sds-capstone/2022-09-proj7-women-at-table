...
![Distribution of the Main Source of Emergency Funds](images/MainSourceFunds.png){width=75%, height=50%}
...
![Decision Tree Classifier Model](images/decision_tree_annotated.png){width=75%, height=50%}
